const EditIcon = (): JSX.Element => {
  return (
    <svg className="w-8 h-8 text-gray-800 rounded-full hover:bg-slate-300 p-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
